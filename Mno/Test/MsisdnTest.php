...
class MsisdnTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetMsisdnDetail()
    {
        ...
        $ms = new \Mno\Msisdn('+38631734068');
        $this->assertEquals('Telekom, 386, 31734068, SI', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+38641734068');
        $this->assertEquals('Telekom, 386, 41734068, SI', $ms->getMsisdnDetail());
        ...
        $ms = new \Mno\Msisdn('+8613111111111');
        $this->assertEquals('China Unicom, 86, 13111111111, CN', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+8613211111111');
        $this->assertEquals('China Unicom, 86, 13211111111, CN', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+8614511111111');
        $this->assertEquals('China Unicom, 86, 14511111111, CN', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+8615511111111');
        $this->assertEquals('China Unicom, 86, 15511111111, CN', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+8615611111111');
        $this->assertEquals('China Unicom, 86, 15611111111, CN', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+8618511111111');
        $this->assertEquals('China Unicom, 86, 18511111111, CN', $ms->getMsisdnDetail());
        ...
        $ms = new \Mno\Msisdn('+8613322222222');
        $this->assertEquals('China Telecom, 86, 13322222222, CN', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+8615322222222');
        $this->assertEquals('China Telecom, 86, 15322222222, CN', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+8618022222222');
        $this->assertEquals('China Telecom, 86, 18022222222, CN', $ms->getMsisdnDetail());

        $ms = new \Mno\Msisdn('+8618122222222');
        $this->assertEquals('China Telecom, 86, 18122222222, CN', $ms->getMsisdnDetail());
